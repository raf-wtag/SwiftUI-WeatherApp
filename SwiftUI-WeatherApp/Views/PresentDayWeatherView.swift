...
struct PresentDayWeatherView: View {
    ...
    var body: some View {
        VStack(spacing: 10) {
            Text("Today")
                ...
                .bold()
            HStack(spacing: 20) {
                LottieView(name: cityVM.getLottieAnimation(for: cityVM.weatherIcon))
...
struct PresentDayWeatherView_Previews: PreviewProvider {
